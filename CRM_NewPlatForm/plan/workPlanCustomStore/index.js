  ...
  ysp.runtime.Model.extendLoadingModel({
    getData_control42_A9IB6L: function (elem) {
      ...
      if ('ascertain' == data.eventType) {
        ...
        var addDayPlanOkBtn = elem.querySelector('#addDayPlanOkBtn');var cwin = elem.ownerDocument.defaultView;if (addTempDayPlanOkBtn) {
