  ...
  ysp.runtime.Model.extendLoadingModel({
    ...
    doAction_uiControl248_nQhTnd: function (data, elem) {
      ...
      if (data.eventType == 'click') {
        var index = +data.dataCustom.index;var lis = elem.querySelector('#tab-head').querySelectorAll("li");if (lis) {
          lis[index].click();
        } // if (index == 1) {
        //   lis[2].click();
        // } else {
    ...
    getData_control286_TRTTCN: function (elem) {
      "use strict";

      var data = {};if ($(elem).length > 0) {
        if ($(elem).find(".ui-pg-input").length > 0) {
          data.current = parseInt($(elem).find(".ui-pg-input")[0].value.trim());
        }if ($(elem).find("#sp_1_pager_list_1").length > 0) {
          data.total = parseInt($(elem).find("#sp_1_pager_list_1")[0].textContent.trim());
        }if ($(elem).find("#prev_pager_list_1").length > 0) {
          /ui-disabled/.test($(elem).find("#prev_pager_list_1")[0].className) ? data.prev = false : data.prev = true;
        }if ($(elem).find("#next_pager_list_1").length > 0) {
          /ui-disabled/.test($(elem).find("#next_pager_list_1")[0].className) ? data.next = false : data.next = true;
        }
      }return data;
    },
    doAction_uiControl274_bnWADp: function (data, elem) {
      "use strict";

      if (data.eventType == 'click') {
        var type = data.dataCustom;if (/prev/.test(type)) {
          var target = $(elem).find("#prev_pager_list_1")[0];if (target) {
            target.click();
          }
        } else if (/next/.test(type)) {
          var target = $(elem).find("#next_pager_list_1")[0];if (target) {
            target.click();
          }
        }
      } else if (data.eventType == 'change') {
        var val = parseInt(data.dataCustom);var target = $(elem).find(".ui-pg-input")[0];if (target) {
          target.value = val;target.dispatchEvent(new Event("change"));ysp.customHelper.fireKeyEvent(target, 'keypress', 13);
        }
      }
    },
    getTemplate_uiControl274_bnWADp: function () {
      var selfTemplate = 'import React, {Component} from \'react\';\nimport {Page} from \'ysp-custom-components\';\n\nexport default class extends React.Component {\n  constructor(props) {\n    super(props);\n    this.onClick=this.onClick.bind(this);\n    this.onChange=this.onChange.bind(this);\n  }\n  onClick(e){\n    var handler=this.props.customHandler;\n    var target=e.target;\n    if(handler){\n      handler({\n        data: target.className,\n        eventType: \'click\'\n      })\n    }\n  }\n  onChange(e){\n\t\tvar handler=this.props.customHandler;\n    var div=this.refs.page;\n    var target=div.querySelector("input");\n    if(handler){\n      handler({\n        data: target.value,\n        eventType: \'change\'\n      })\n    }\n  }\n  componentDidMount(){\n    var div=this.refs.page;\n    var val=this.props.customData.current;\n    try{\n      var target=div.querySelector("input");\n      target.value=val;\n      target.dispatchEvent(new Event(\'change\'));\n    }catch(err){}\n  }\n  componentDidUpdate(prevProps,prevState){\n    var div=this.refs.page;\n    var val=this.props.customData.current;\n    try{\n      var target=div.querySelector("input");\n      target.value=val;\n      target.dispatchEvent(new Event(\'change\'));\n    }catch(err){}\n  }\n  render(){\n    var data=this.props.customData;\n    return data?<div className="page-container" ref="page">\n    \t<Page\n        pageState={data && data.total && data.total>1?true:false}\n        show={data && data.total && data.total>1?true:false}\n        prevState={data && data.prev?true:false}\n        nextState={data && data.next?true:false}\n        currentPage={data && data.current}\n        pageNumber={data && data.total}\n        prev={this.onClick}\n        next={this.onClick}\n        Click={this.onChange}\n     /></div>:null\n  }\n}';
      return '\'use strict\';\n\nObject.defineProperty(exports, "__esModule", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _react = require(\'react\');\n\nvar _react2 = _interopRequireDefault(_react);\n\nvar _yspCustomComponents = require(\'ysp-custom-components\');\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn\'t been initialised - super() hasn\'t been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar _class = function (_React$Component) {\n  _inherits(_class, _React$Component);\n\n  function _class(props) {\n    _classCallCheck(this, _class);\n\n    var _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, props));\n\n    _this.onClick = _this.onClick.bind(_this);\n    _this.onChange = _this.onChange.bind(_this);\n    return _this;\n  }\n\n  _createClass(_class, [{\n    key: \'onClick\',\n    value: function onClick(e) {\n      var handler = this.props.customHandler;\n      var target = e.target;\n      if (handler) {\n        handler({\n          data: target.className,\n          eventType: \'click\'\n        });\n      }\n    }\n  }, {\n    key: \'onChange\',\n    value: function onChange(e) {\n      var handler = this.props.customHandler;\n      var div = this.refs.page;\n      var target = div.querySelector("input");\n      if (handler) {\n        handler({\n          data: target.value,\n          eventType: \'change\'\n        });\n      }\n    }\n  }, {\n    key: \'componentDidMount\',\n    value: function componentDidMount() {\n      var div = this.refs.page;\n      var val = this.props.customData.current;\n      try {\n        var target = div.querySelector("input");\n        target.value = val;\n        target.dispatchEvent(new Event(\'change\'));\n      } catch (err) {}\n    }\n  }, {\n    key: \'componentDidUpdate\',\n    value: function componentDidUpdate(prevProps, prevState) {\n      var div = this.refs.page;\n      var val = this.props.customData.current;\n      try {\n        var target = div.querySelector("input");\n        target.value = val;\n        target.dispatchEvent(new Event(\'change\'));\n      } catch (err) {}\n    }\n  }, {\n    key: \'render\',\n    value: function render() {\n      var data = this.props.customData;\n      return data ? _react2.default.createElement(\n        \'div\',\n        { className: \'page-container\', ref: \'page\' },\n        _react2.default.createElement(_yspCustomComponents.Page, {\n          pageState: data && data.total && data.total > 1 ? true : false,\n          show: data && data.total && data.total > 1 ? true : false,\n          prevState: data && data.prev ? true : false,\n          nextState: data && data.next ? true : false,\n          currentPage: data && data.current,\n          pageNumber: data && data.total,\n          prev: this.onClick,\n          next: this.onClick,\n          Click: this.onChange\n        })\n      ) : null;\n    }\n  }]);\n\n  return _class;\n}(_react2.default.Component);\n\nexports.default = _class;';
    }
